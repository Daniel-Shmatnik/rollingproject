...
def home():
    ...
    # bUG FIX 1: Added missing API call to fetch VPCs
    vpcs = ec2_client.describe_vpcs()
    vpc_data = [{"VPC ID": vpc["VpcId"], "CIDR": vpc["CidrBlock"]} for vpc in vpcs["Vpcs"]]
    
    #  bUG FIX 2: Added missing API call to fetch Load Balancers
    ...
    #  bUG FIX 3: Added missing API call to fetch AMIs owned by the account
